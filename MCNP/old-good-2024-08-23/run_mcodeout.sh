...
process_directory() {
    ...
    echo "Running MCODEOUT12 for input file: $input_file" | tee -a "$log_file"
    nohup /home/patrick/MCODE12/mcodeout12 "$input_file" >> "$log_file" 2>&1
...
# Log file location
log_file="/home/patrick/mcodeout12.log"

# Clear previous log file
echo "Starting MCODEOUT12 execution at $(date)" > "$log_file"
