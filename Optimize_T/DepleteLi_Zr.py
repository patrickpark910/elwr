...
def main():
    ...
    c_list = [161,162,171] # list(range(60, 141, 5))
...
def K_p(c):
    ''' k-eff penalty
    '''
    bu00 = 2.004552E-06*c**2 - 1.572914E-03*c
    bu_1 = 1.494918E-06*c**2 - 1.419411E-03*c
    bu01 = 1.443485E-06*c**2 - 1.367179E-03*c
    bu05 = 9.256571E-07*c**2 - 1.169838E-03*c
    bu10 = 1.628630E-07*c**2 - 9.402759E-04*c
    
    return 3/2*bu01-1/2*bu_1
